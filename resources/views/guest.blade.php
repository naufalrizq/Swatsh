                ...
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    ...
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-black-75 mb-5">Berolahraga ditempat yang membuat kamu nyaman
                          gabung dengan kami sekarang untuk dapat lebih mudah mengetahui tempat olahraga yang ada disekitar anda</p>
                        <a class="btn btn-danger btn-xl" href="{{ route('home') }}">TEMUKAN SEKARANG</a>
                    </div>
                </div>
            </div>
        </header>
